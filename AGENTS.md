...
- Edit roadmap/status on `develop` only ([docs/planning/README.md](docs/planning/README.md) explains
  the model and how to promote public changes to `main`). Don't link public docs into `docs/planning/`.
